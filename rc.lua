...
startmenu = {
    { "Shutdown", terminal .. " -e shutdown now --poweroff" },
    { "Restart", terminal .. " -e reboot" },
    { "Logout", function() awesome.quit() end},
    { "120Hz", terminal .. " -e /bin/set-refresh-rate.sh"},
    { "Update", terminal .. " -e sudo pacman -Syyu "},
}
...
mymainmenu = awful.menu({ 
    items = { 
        ...
        { 'keyboard', kblayouts, beautiful.awesome_icon},
        { "computer", startmenu, beautiful.awesome_icon },
    }
})
...
awful.screen.connect_for_each_screen(function(s)
    ...
    if s.index==1 then
        ...
        awful.tag({ " 1 ", " 2 ", " 3 " }, screen[1], awful.layout.layouts[1])
...
{
    " -e sudo pacman -Syyu",
    " -e /bin/set-refresh-rate.sh"
}
if autoexecCommands then
    for command =1, #autoexecCommands do
        awful.spawn.with_shell(terminal .. autoexecCommands[command])
    end
end
